...
export class StudentDashComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    const apiUrl = `http://localhost:8080/students/user11`;
  ...
  getData() {
    ...
    const apiUrl = `http://localhost:8080/attendance?startDate=${startDateFormatted}&endDate=${endDateFormatted}&userId=user11`;
